  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-sm": "0 0 12px oklch(var(--accent) / 0.3)",
        "glow-md": "0 0 24px oklch(var(--accent) / 0.5)",
        "glow-lg": "0 0 32px oklch(var(--accent) / 0.6)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "glow-pulse": {
          ...
          "50%": {
            boxShadow: "0 0 24px oklch(var(--accent) / 0.6)",
          },
        },
        "shimmer-sweep": {
          "0%": {
      ...
      animation: {
        ...
        "shimmer": "shimmer-sweep 2s infinite",
