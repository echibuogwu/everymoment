import { a as useBackend, c as useNavigate, r as reactExports, Q as QUERY_KEYS, f as useQuery, j as jsxRuntimeExports } from "./index-DXT1CttK.js";
import { L as Layout, A as AnimatePresence, B as Button, C as Compass } from "./Layout-DiYsrWyj.js";
...
import { C as Calendar, M as MapPin } from "./map-pin-Dhjj-nbW.js";
...
function ExplorePage() {
  ...
  reactExports.useEffect(() => {
    const onPopState = () => {
      ...
      setFilters((prev) => {
        const same = p.query === prev.query && p.dateFrom === prev.dateFrom && p.dateTo === prev.dateTo && p.tags.length === prev.tags.length && p.tags.every((t, i) => t === prev.tags[i]);
        if (same) return prev;
        return {
          ...prev,
          query: p.query,
