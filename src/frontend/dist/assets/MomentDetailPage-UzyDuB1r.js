import { q as QueryObserver, s as infiniteQueryBehavior, t as hasPreviousPage, v as hasNextPage, w as useBaseQuery, a as useBackend, d as useQueryClient, f as useQuery, e as useMutation, Q as QUERY_KEYS, A as AccessStatus, j as jsxRuntimeExports, g as Link, u as useAuth, c as useNavigate, x as useMomentWaitlist, y as RsvpStatus, r as reactExports, i as cn, E as ExternalBlob, B as MemoryMediaKind, M as MediaKind, h as useParams, k as useIsBookmarked, l as useBookmarkMoment, m as useUnbookmarkMoment, C as useAnnouncements, D as usePostAnnouncement, F as useDeleteAnnouncement, G as createActorWithConfig, H as createActor } from "./index-DXT1CttK.js";
import { B as Badge } from "./badge-ClpeqgBf.js";
import { f as Avatar, g as AvatarImage, h as AvatarFallback, M as MessageCircle, A as AnimatePresence, L as Layout, B as Button, i as Bookmark, n as ShieldCheck } from "./Layout-DiYsrWyj.js";
import { S as Skeleton } from "./skeleton-bPGqVL12.js";
import { Q as QRCodeSVG, T as Ticket } from "./index-CzV7IUDd.js";
...
import { C as CircleX } from "./circle-x-5isUsdKS.js";
import { E as EmptyState } from "./EmptyState-CZz9I97Z.js";
import { U as Users } from "./users-Dx63TV8c.js";
import { U as UserMinus, L as LogIn, u as useScroll, a as useTransform, E as ExternalLink } from "./use-transform-DNWEdqrq.js";
...
import { C as ChevronUp, A as AlarmClock } from "./chevron-up-B53wVorS.js";
...
import { i as isPrivateVisibility, B as BookmarkCheck } from "./MomentCard-V-mu_YB1.js";
import { I as Input } from "./input-BroRf_VE.js";
import { C as ConfirmDialog } from "./ConfirmDialog-DRxF9xUv.js";
import { F as FileText, I as Image } from "./image-gdxeBEdv.js";
import { U as User } from "./user--0LaG4fi.js";
import { U as Upload } from "./upload-DhKExZrS.js";
import { L as Lock, G as Globe, C as Calendar, M as MapPin } from "./map-pin-Dhjj-nbW.js";
...
const FolderPlus = createLucideIcon("folder-plus", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Images = createLucideIcon("images", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const MessageSquareHeart = createLucideIcon("message-square-heart", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function AccessEntryRow({
  ...
  const displayName = (profile == null ? void 0 : profile.username) ? `@${profile.username}` : (profile == null ? void 0 : profile.name) ?? `${userId.slice(0, 14)}…`;
  const initials = ((profile == null ? void 0 : profile.username) ?? (profile == null ? void 0 : profile.name) ?? "??").slice(0, 2).toUpperCase();
  const avatarUrl = (_a = profile == null ? void 0 : profile.photo) == null ? void 0 : _a.getDirectURL();
  const profileUsername = profile == null ? void 0 : profile.username;
    ...
    "li",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0 flex-1", children: [
          profileUsername ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/profile/$username",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "w-9 h-9 shrink-0", children: [
                avatarUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarImage, { src: avatarUrl, alt: displayName }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-accent/20 text-accent font-semibold text-xs", children: initials })
              ] })
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground truncate", children: displayName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: isPendingRow ? `Requested ${formatDate$2(req.requestedAt)}` : req.resolvedAt ? `Approved ${formatDate$2(req.resolvedAt)}` : "Approved" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 flex-shrink-0", children: isPendingRow ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
function AccessRequestsPanel({ momentId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "access-requests-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      ...
      pending.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body py-2", children: "No pending requests." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: pending.map((req) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        AccessEntryRow,
        {
          req,
          isPendingRow: true,
          onApprove: () => resolveMutation.mutate({
            requester: req.requester,
            approved: true
          }),
          onDeny: () => resolveMutation.mutate({
            requester: req.requester,
            approved: false
          }),
          isMutating
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      ...
      approved.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body py-2", children: "No approved users yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: approved.map((req) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        AccessEntryRow,
        {
          req,
          isPendingRow: false,
...
function WaitlistSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mt-6", "data-ocid": "waitlist-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-1 mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 text-muted-foreground" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-body font-semibold text-muted-foreground", children: [
        "Waitlist (",
        waitlist.length,
        ")"
      ] })
    ] }),
    (_a = userProfiles.data) == null ? void 0 : _a.map((profile, i) => {
      var _a2;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "w-9 h-9 flex-shrink-0 ring-2 ring-border", children: [
              (profile == null ? void 0 : profile.photo) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                AvatarImage,
                {
                  src: profile.photo.getDirectURL(),
                  alt: (profile == null ? void 0 : profile.username) ?? ""
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "font-display font-bold text-xs bg-muted text-muted-foreground", children: profile ? profile.username.slice(0, 2).toUpperCase() : "?" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body font-semibold text-sm text-foreground truncate", children: profile ? `@${profile.username}` : `Position ${i + 1}` }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto flex-shrink-0 text-xs font-body font-semibold text-yellow-500 bg-yellow-500/10 px-2 py-1 rounded-full", children: "Waitlisted" })
          ]
        },
        ((_a2 = waitlist[i]) == null ? void 0 : _a2.toString()) ?? i
      );
    })
  ] });
}
function AttendeesTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2", "data-ocid": "attendees-list", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: attendeesQuery.data.map((attendee) => {
    ...
    maxAttendees && /* @__PURE__ */ jsxRuntimeExports.jsx(WaitlistSection, { momentId, isOwner })
  ] });
}
...
function MentionPicker({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: filtered.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onMouseDown: (e) => {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-medium", children: "@" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: u })
          ]
        },
        u
      ))
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-body text-muted-foreground/60", children: formatRelativeTime$1(memory.createdAt) })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    memory.content && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      MentionText,
                      {
                        text: memory.content,
                        onNavigate: (username) => navigate({
                          to: "/profile/$username",
                          params: { username }
                        })
                      }
...
function MemoriesTab({ momentId }) {
  ...
  const [attendeeUsernames, setAttendeeUsernames] = reactExports.useState([]);
  ...
  const mentionStartRef = reactExports.useRef(null);
  useQuery({
    ...
    queryFn: async () => {
      ...
      const usernames = profiles.filter((p) => p !== null).map((p) => p.username);
  ...
  const handleMentionSelect = reactExports.useCallback(
    (username) => {
      var _a, _b;
      if (mentionStartRef.current === null) return;
      const before = content.slice(0, mentionStartRef.current);
      const after = content.slice(
        ((_a = textareaRef.current) == null ? void 0 : _a.selectionStart) ?? content.length
      );
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 space-y-2", "data-ocid": "memories-compose", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-end gap-2", children: [
            mentionQuery !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
              MentionPicker,
              {
                query: mentionQuery,
...
function AnnouncementsSection({
  ...
  const visible = announcements == null ? void 0 : announcements.filter((a) => !dismissed.has(Number(a.id)));
  if (isLoading) return null;
  if (!isOwner && (!visible || visible.length === 0)) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "announcements-section", children: [
    isOwner && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-2xl p-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { className: "w-4 h-4 text-accent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-semibold text-foreground", children: "Post Announcement" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: postMutation.isPending ? "Posting…" : "Post Announcement"
        }
      )
    ] }),
    visible && visible.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: visible.map((ann) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { className: "w-4 h-4 text-accent flex-shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-foreground leading-relaxed", children: ann.text }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: formatRelativeTime(ann.createdAt) })
          ] }),
          isOwner ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              onClick: () => setDismissed((prev) => /* @__PURE__ */ new Set([...prev, Number(ann.id)])),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-body text-muted-foreground flex items-center gap-1.5", children: [
          ...
          isFull ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              ...
              children: waitlisted > 0 ? `Full · ${waitlisted} on waitlist` : "Full"
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1.5 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `h-full rounded-full transition-all duration-500 ${isFull ? "bg-destructive" : pct > 75 ? "bg-yellow-500" : "bg-green-500"}`,
            style: { width: `${pct}%` }
          }
        ) }),
...
function BookmarkButton({ momentId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: cn(
        ...
        isBookmarked ? "bg-accent text-accent-foreground shadow-sm" : "glass-card text-foreground hover:bg-accent/10 border border-border"
      ),
      "data-ocid": "bookmark-toggle-button",
      children: [
        isBookmarked ? /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkCheck, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Bookmark, { className: "w-5 h-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isBookmarked ? "Saved" : "Save" })
      ]
    }
  );
}
function generateIcs(moment) {
  const start = new Date(Number(moment.eventDate / 1000000n));
  ...
  const lines = [
    ...
    moment.description ? `DESCRIPTION:${moment.description.replace(/\n/g, "\\n")}` : "",
    "END:VEVENT",
    "END:VCALENDAR"
  ].filter(Boolean).join("\r\n");
  return lines;
}
function googleCalendarUrl(moment) {
  const start = new Date(Number(moment.eventDate / 1000000n));
  const end = new Date(start.getTime() + 2 * 60 * 60 * 1e3);
  const pad = (n) => String(n).padStart(2, "0");
...
function ShareSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 pt-4 pb-3 border-b border-border/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-accent/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "w-3.5 h-3.5 text-accent" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body uppercase tracking-wider", children: "Link" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                onClick: handleCopy,
                className: `w-full flex items-center gap-3 px-4 py-3 rounded-xl border transition-all duration-200 text-left font-body text-sm button-spring ${copied ? "border-accent/50 bg-accent/10 text-accent" : "border-border bg-muted/30 text-foreground hover:bg-muted/50 hover:border-border/70"}`,
                "data-ocid": "copy-share-link-btn",
                children: [
                  copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-accent flex-shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-4 h-4 text-muted-foreground flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 truncate text-muted-foreground text-xs", children: shareUrl }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body uppercase tracking-wider", children: "QR Code" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white p-3 rounded-xl shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    QRCodeSVG,
                    {
                      value: shareUrl,
                      size: 144,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body text-center", children: "Scan to open this moment" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body uppercase tracking-wider", children: "Add to Calendar" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg flex items-center justify-center bg-[#4285f4]/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-3.5 h-3.5 text-[#4285f4]" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-body font-medium text-muted-foreground leading-tight", children: "Google" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg flex items-center justify-center bg-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3.5 h-3.5 text-foreground" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-body font-medium text-muted-foreground leading-tight", children: "Apple" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg flex items-center justify-center bg-accent/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarPlus, { className: "w-3.5 h-3.5 text-accent" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-body font-medium text-muted-foreground leading-tight", children: ".ics File" })
                  ]
                }
              )
            ] })
...
function AgendaTimeline({ items }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "agenda-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AlarmClock, { className: "w-4 h-4 text-accent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground", children: "Agenda" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pl-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "relative",
          "data-ocid": `agenda-item.${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -left-[14px] top-1 w-2.5 h-2.5 rounded-full bg-accent ring-2 ring-background" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold text-accent", children: item.time }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-body font-medium text-foreground", children: item.title })
              ] }),
              item.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body leading-relaxed", children: item.description })
            ] })
          ]
        },
        Number(item.id)
...
function NullMomentAccessRequest({
  ...
  const isDenied = currentStatus === AccessStatus.denied || currentStatus === AccessStatus.revoked;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "flex flex-col items-center text-center space-y-5",
      "data-ocid": "private-moment-preview",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full glass-card flex items-center justify-center glow-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-7 h-7 text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-xl text-foreground", children: "Private Moment" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: "This moment is private. Request access to view it." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 w-full max-w-xs", children: requestSent || isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "glass-card rounded-2xl p-4 flex flex-col items-center gap-2",
            "data-ocid": "access-pending-badge",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-6 h-6 text-accent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-semibold text-foreground", children: requestSent ? "Access request sent!" : "Access Requested — Pending Approval" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "The owner will review your request." })
            ]
          }
        ) : isDenied ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: currentStatus === AccessStatus.revoked ? "Your access has been revoked." : "Your access request was denied." }),
          inlineError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive font-body", children: inlineError }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        ] }) : !isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: login,
...
function MomentDetailContent({ momentId }) {
  ...
  const { data: accessStatus, isLoading: accessStatusLoading } = useQuery({
  ...
  const hasAccess = !moment || !isPrivate || moment.isOwner || isApprovedStatus(moment.callerAccessStatus);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AuthGuard, { requireAuth: false, currentPath: `/moments/${momentId}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: isLoading || moment === null && accessStatusLoading || moment === null && accessStatus === AccessStatus.approved ? /* @__PURE__ */ jsxRuntimeExports.jsx(MomentDetailSkeleton, {}) : !moment && accessStatus === null && !accessStatusLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-6 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
    ...
    ) }) : !moment && accessStatus !== void 0 && accessStatus !== AccessStatus.approved ? (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
    ...
    ] }) : moment ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-10", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              moment.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: moment.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body uppercase tracking-wide", children: "Your RSVP" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(RsvpButton, { momentId }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkButton, { momentId })
            ] }),
            ...
            showShare && /* @__PURE__ */ jsxRuntimeExports.jsx(ShareSection, { momentId: moment.id, moment })
          ]
        }
      ),
      (moment.isOwner || isAttending) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-0 z-header py-3 bg-background/80 backdrop-blur-md -mx-4 px-4 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        GlassTabBar,
        {
          tabs,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            validActiveTab === "people" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              AttendeesTab,
              {
                momentId,
                maxAttendees: moment.maxAttendees,
      ...
      moment.agendaItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 glass-card rounded-2xl p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaTimeline, { items: moment.agendaItems }) })
    ] }) : null }),
