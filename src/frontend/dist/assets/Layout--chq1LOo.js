import { $ as useRouterState, r as reactExports, j as jsxRuntimeExports, a0 as shimExports, i as cn, a1 as clsx, a2 as React, a3 as reactDomExports, J as React$1, a4 as ReactDOM, u as useAuth, b as useProfile, g as Link, o as useIsAdmin, z, a5 as useUnreadNotificationCount, N as useUnreadMessageCount } from "./index-CtLY6vs2.js";
import { P as Primitive$1, S as Slot$1, c as composeRefs$1, u as useComposedRefs$1 } from "./index-DIX-OhXh.js";
import { c as createLucideIcon, M as MotionConfigContext, d as isHTMLElement$1, u as useConstant, P as PresenceContext, q as usePresence$1, j as useIsomorphicLayoutEffect$1, L as LayoutGroupContext, m as motion } from "./proxy-C4ENgEup.js";
import { U as User } from "./user-DWv8V36G.js";
import { M as Moon, S as Sun } from "./sun-Dp_dfXPb.js";
...
const Compass = createLucideIcon("compass", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function NotificationBell() {
  ...
  const { data: count2 = 0 } = useUnreadNotificationCount();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      to: "/notifications",
      className: "relative flex items-center justify-center w-9 h-9 rounded-full hover:bg-white/10 transition-colors duration-200 text-foreground/70 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
      "aria-label": `Notifications${count2 > 0 ? ` (${count2} unread)` : ""}`,
      "data-ocid": "notification-bell",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-4 h-4" }),
        count2 > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-0.5 -right-0.5 flex items-center justify-center min-w-[16px] h-4 px-0.5 rounded-full bg-destructive text-[10px] font-bold text-destructive-foreground leading-none", children: count2 > 99 ? "99+" : count2 })
      ]
    }
  );
}
function GlassHeader({ scrolled }) {
  var _a, _b;
  ...
  const initials = ((_b = profile == null ? void 0 : profile.username) == null ? void 0 : _b.slice(0, 2).toUpperCase()) ?? "?";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.header,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 h-14 flex items-center justify-between", children: [
          ...
          Link,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.span,
              {
                ...
                style: {
                  background: "linear-gradient(135deg, oklch(0.72 0.28 280), oklch(0.78 0.22 310))",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
          ...
          isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { whileTap: { scale: 0.93 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              asChild: true,
              size: "sm",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/moments/new", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-3.5 h-3.5" }),
                "New"
              ] })
            }
          ) }),
          isAuthenticated && profile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.button,
              {
                ...
                whileTap: { scale: 0.93 },
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "w-8 h-8 ring-2 ring-white/20", children: [
                  avatarUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarImage, { src: avatarUrl, alt: profile.username }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs font-display font-semibold bg-accent/20 text-accent-foreground", children: initials })
                ] })
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-52 z-50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 py-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-medium text-foreground truncate", children: [
                "@",
                profile.username
              ] }) }),
          ...
          ] }) : isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-muted animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { whileTap: { scale: 0.93 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              size: "sm",
              variant: "default",
...
function NavMessagesBadge() {
  const { data: count2 = 0 } = useUnreadMessageCount();
  if (count2 === 0) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-0.5 -right-0.5 flex items-center justify-center min-w-[14px] h-3.5 px-0.5 rounded-full bg-destructive text-[9px] font-bold text-destructive-foreground leading-none", children: count2 > 9 ? "9+" : count2 });
}
                      ...
                      motion.div,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative", children: [
                            ...
                            label === "Messages" && /* @__PURE__ */ jsxRuntimeExports.jsx(NavMessagesBadge, {})
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-body font-medium leading-none tracking-wide", children: label })
                        ]
                      }
                    )
                  ]
              ...
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.72 0.28 280), oklch(0.65 0.22 310))",
                      boxShadow: "0 0 20px oklch(0.72 0.28 280 / 0.55), 0 4px 12px rgba(0,0,0,0.35)"
                    },
                    "data-ocid": "bottom-nav-create",
                    "aria-label": "Create moment",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4.5 h-4.5 text-white", size: 18 })
                  }
                )
              }
            )
...
function Layout({ children, hideNav = false }) {
  ...
  const pageTransition = prefersReducedMotion ? { duration: 0 } : { type: "spring", stiffness: 300, damping: 30 };
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            style: {
              background: "radial-gradient(ellipse 80% 60% at 50% 0%, oklch(0.18 0.06 290 / 0.6) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GlassHeader, { scrolled }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 max-w-2xl mx-auto w-full px-4 pt-14 pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            initial: pageInitial,
            animate: pageAnimate,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "footer",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground font-body", children: [
              "© ",
        ...
        !hideNav && /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingBottomNav, { scrollingDown })
      ]
    }
  );
}
export {
  ...
  useId as k,
  Presence as l,
  createRovingFocusGroupScope as m,
  ShieldCheck as n,
  createContext2 as o,
  Portal$1 as p,
  hideOthers as q,
