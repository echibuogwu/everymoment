import { a as useBackend, c as useNavigate, r as reactExports, f as useQuery, j as jsxRuntimeExports, Q as QUERY_KEYS, g as Link } from "./index-CtLY6vs2.js";
...
import { A as AnimatePresence, L as Layout, S as Sparkles, P as Plus, a as Activity } from "./Layout--chq1LOo.js";
import { C as CalendarDays } from "./calendar-days-Cnte5sXl.js";
...
function DashboardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthGuard, { requireAuth: true, requireProfile: true, currentPath: "/dashboard", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 space-y-5", children: [
          ...
          children: TAB_ITEMS.map((tab) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-xs font-medium transition-colors duration-150 ${isActive ? "bg-accent text-accent-foreground shadow-sm" : "text-muted-foreground hover:text-foreground hover:bg-muted/30"}`,
      ...
      activeTab === "moments" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 8 },
          animate: { opacity: 1, y: 0 },
          transition: { duration: 0.3 },
          className: "space-y-3",
          children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(MomentGridSkeleton, {}) : !moments || moments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
      ...
      activeTab === "activity" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 8 },
          animate: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-accent/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-5 h-5 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground", children: "Activity Feed" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "See what people you follow are doing" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
