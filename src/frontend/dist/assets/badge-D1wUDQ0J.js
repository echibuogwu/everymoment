import { x as useRouterState, r as reactExports, j as jsxRuntimeExports, y as shimExports, h as cn, B as React, C as reactDomExports, R as React$1, D as ReactDOM, u as useAuth, b as useProfile, i as useIsAdmin, F as Link, z } from "./index-DlqwQ7hd.js";
import { P as Primitive$1, c as composeRefs, u as useComposedRefs, B as Button, S as Slot$1, a as cva } from "./AuthGuard-DwWnaabs.js";
...
function Layout({ children, hideNav = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background", children: [
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 h-14 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground tracking-tight", children: "EveryMoment" })
            }
          ),
            ...
            isAuthenticated && profile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "w-8 h-8 ring-2 ring-border", children: [
                    avatarUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarImage, { src: avatarUrl, alt: profile.username }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs font-display font-semibold bg-secondary text-secondary-foreground", children: initials })
                  ] })
                }
              ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 max-w-2xl mx-auto w-full px-4 pb-28", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "w-full bg-card border-t border-border/60 py-4 text-center mb-16 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground font-body", children: [
      "© ",
    ...
    !hideNav && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        className: "fixed bottom-0 left-0 right-0 z-30 bg-card/95 backdrop-blur-sm border-t border-border/60",
        "data-ocid": "bottom-nav",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto flex h-16", children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-body font-medium leading-none", children: label })
                ]
              },
              to
            );
          ...
          isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-foreground flex items-center justify-center shadow-md -mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Plus,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-body font-medium leading-none", children: "New" })
              ]
            }
          )
        ] })
...
export {
  ...
  AvatarImage as a,
  AvatarFallback as b,
  useControllableState as c,
  Primitive as d,
  useId as e,
  composeEventHandlers as f,
  Presence as g,
  createRovingFocusGroupScope as h,
  createContextScope as i,
  createContext2 as j,
  Portal$1 as k,
  hideOthers as l,
  ReactRemoveScroll as m,
  useFocusGuards as n,
  createSlot as o,
  createSlottable as p,
  useDirection as u
};
